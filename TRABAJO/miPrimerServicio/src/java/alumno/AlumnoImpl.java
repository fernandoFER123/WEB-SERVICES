...
public class AlumnoImpl {
    ...
    String sql="";
    ArrayList<Alumno> ListAlumnoEgresados = new ArrayList<Alumno>();
    ...
    public ArrayList<Alumno> listaEgresados(String s_anhio_egreso)throws Exception{
        try{
            ...
            while (rs.next ()){
                ...
                ListAlumnoEgresados.add(datos);
                
            }
        }catch (SQLException ex){ System.out.println("ERRORRRR"+ ex.getMessage());}
        return ListAlumnoEgresados;
    }
