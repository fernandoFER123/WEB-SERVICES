...
public class Alumno implements Serializable{
    ...
    public String getO_alumno_id(){     return o_alumno_id;}
    public String getO_alumno_codigo(){     return o_alumno_codigo;}
    public String getO_alumno_nombres(){     return o_alumno_nombres;}
    public String getO_alumno_apellido_paterno(){     return o_alumno_apellido_paterno;}
    public String getO_alumno_apellido_materno(){     return o_alumno_apellido_materno;}
    public String getO_alumno_direccion(){     return o_alumno_direccion;}
    ...
    public void setO_alumno_apellido_materno(String o_alumno_apellido_materno){
        this.o_alumno_id = o_alumno_apellido_materno;
    }
